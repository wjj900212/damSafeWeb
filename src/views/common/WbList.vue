<template>
  <a-drawer title="外包支出明细" :maskClosable="false" width=75% placement="right" :closable="false"
     :visible="wbListVisiable"  style="height: calc(100% - 55px);overflow: auto;padding-bottom: 53px;">
...
export default {
  ...
  watch: {
    wbListVisiable () {
      // console.log(this.wbListVisiable)
      // if (this.wbListVisiable) {
      //   this.fetch()
      // }
    }
  }
