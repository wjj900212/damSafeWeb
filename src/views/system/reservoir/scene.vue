      ...
      <a-table ref="TableInfo" :rowKey="(record,index)=>{return index}" :columns="columns" :dataSource="dataSource"
        ...
        <template slot="operation" slot-scope="text, record">
          <div class="icons-list">
            ...
            <a href="javascript:;" v-if="record.hiddenType==12"
              @click="hiddenId=record.hiddenId;lineVisible=true">浸润线配置</a>
...
export default {
  ...
  methods: {
    ...
    getDistData (distData) {
     // console.log('cityCode', distData)
      this.queryParams.cityCode = distData.cityCode
      if (JSON.stringify(distData) === '{}') {
        delete this.queryParams.cityCode
      }
    },
    init () {
