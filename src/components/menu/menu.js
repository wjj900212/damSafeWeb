...
export default {
  ...
  methods: {
    ...
    renderItem: function (h, menu, pIndex, index) {
      if (!menu.hidden && menu.type !== '3') {
        return menu.children && menu.children.length > 0 && menu.isItem === '0' ? this.renderSubMenu(h, menu, pIndex, index) : this.renderMenuItem(h, menu, pIndex, index)
      }
    },
    ...
    updateMenu () {
      ...
      if (routes.length >= 5 && this.$route.meta.hidden) {
        routes.pop()
