        ...
        <div v-else-if="item.key === 'dd'">
          <div>
            ...
            <div>
              ...
              <!-- <div class="pnExport" @click="exportSinglePn()">
                <img src="static/images/Download拷贝2@2x.png" style="width:19px;height:16px;"/>
                <span style="font-family: 'PingFang SC Heavy';color:#00ebc0;font-size:18px;">导出</span>
              </div> -->
            </div>
...
import Echarts3D from "@/components/echarts/Echarts3D.vue";
...
import EchartsZLine from "@/components/echarts/EchartsZLine.vue";
import EchartsXYLine from "@/components/echarts/EchartsXYLine.vue";
import IndexSafetyDescription from "../../views/warn/indexSafetyDescription";
